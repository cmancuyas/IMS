...
public class ProductController : Controller
{
    ...
    public ProductController(IProductRepository dbProduct, IMapper mapper, IFileRepository fileRepository)
    {
    ...
    public async Task<ActionResult<APIResponse>> GetProduct(int id)
    {
        try
        {
            ...
            var Product = await _dbProduct.GetAsync(x => x.Id == id);
            if (Product == null)
            {
                _response.StatusCode = HttpStatusCode.BadRequest;
    ...
    public async Task<ActionResult<APIResponse>> CreateProduct([FromForm] ProductCreateDTO createDTO)
    {
        try
        {
            if (await _dbProduct.GetAsync(x => x.Name.ToLower() == createDTO.Name.ToLower()) != null)
            {
