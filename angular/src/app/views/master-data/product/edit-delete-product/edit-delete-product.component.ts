...
export class EditDeleteProductComponent implements OnInit {
  ...
  buildForm() {
    this.editProductForm = this.formBuilder.group({
      ...
      qtyInStock: [this.product.qtyInStock, [Validators.required]],
      valueOnHand: [this.product.valueOnHand, [Validators.required]],
    });
    ...
    if (this.editPage == false) {
      ...
      this.editProductForm.get('purchasePrice')?.disable();
      this.editProductForm.get('salesPrice')?.disable();
      this.editProductForm.get('qtyInStock')?.disable();
      this.editProductForm.get('valueOnHand')?.disable();
    }
  }
